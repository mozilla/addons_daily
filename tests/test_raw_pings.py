...
def test_bkgd_load_time(raw_pings):
    output = (
        get_bkgd_load_time(raw_pings)
        .orderBy("addon_id", "avg_webext_background_page_load_ms_by_addonid")
        .collect()
    )
    expected_output = [
        ...
        Row(
            addon_id="firefox@ghostery.com",
            avg_webext_background_page_load_ms_by_addonid=7609.0,
        ),
        Row(
            addon_id="formautofill@mozilla.org",
            avg_webext_background_page_load_ms_by_addonid=440.0,
        ),
        Row(
            addon_id="formautofill@mozilla.org",
            avg_webext_background_page_load_ms_by_addonid=964.0,
        ...
        Row(
            addon_id="formautofill@mozilla.org",
            avg_webext_background_page_load_ms_by_addonid=1295.0,
        ),
        Row(
            addon_id="formautofill@mozilla.org",
            avg_webext_background_page_load_ms_by_addonid=5134.0,
        ),
        Row(
            addon_id="fxmonitor@mozilla.org",
            avg_webext_background_page_load_ms_by_addonid=485.0,
        ),
        Row(
            addon_id="fxmonitor@mozilla.org",
            avg_webext_background_page_load_ms_by_addonid=964.0,
        ...
        Row(
            addon_id="screenshots@mozilla.org",
            avg_webext_background_page_load_ms_by_addonid=5665.0,
        ),
        Row(
        ...
        Row(
            addon_id="webcompat@mozilla.org",
            avg_webext_background_page_load_ms_by_addonid=4653.0,
        ),
        Row(
